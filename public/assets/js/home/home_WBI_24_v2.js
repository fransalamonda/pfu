    ...
    var datatable = function(){
        ...
        */
        ...
        forml2.submit(function(e){
            ...
            // if(area_select=== ''){
            //     toastr.options = {"closeButton": true,"debug": false, "newestOnTop": false, "progressBar": true, "positionClass": "toast-top-right", "preventDuplicates": false, "onclick": null, "showDuration": "300", "hideDuration": "1000", "timeOut": "5000", "extendedTimeOut": "1000", "showEasing": "swing", "hideEasing": "linear", "showMethod": "fadeIn", "hideMethod": "fadeOut" }; toastr["warning"](" Spare Part Detail * ");
            //     document.getElementById("area_select").focus();
            //     return false;
            // }
            // if(d_sel=== ''){
            //     toastr.options = {"closeButton": true,"debug": false, "newestOnTop": false, "progressBar": true, "positionClass": "toast-top-right", "preventDuplicates": false, "onclick": null, "showDuration": "300", "hideDuration": "1000", "timeOut": "5000", "extendedTimeOut": "1000", "showEasing": "swing", "hideEasing": "linear", "showMethod": "fadeIn", "hideMethod": "fadeOut" }; toastr["warning"](" Spare Part Arrived (ETA) * ");
            //     document.getElementById("d_sel").focus();
            //     return false;
            // }
            Swal.fire({
                //title: 'Are you sure?',
        ...
        */
        ...
        table_p_action.on('click', 'a.btnRes',function(e){
            ...
            // var sd       = _self.data("sd");
            // var pd       = _self.data("pd");
...
//                            $("strong#equipment_code").html(obj.Equipment_Code);
        ...
        */
        ...
        form_in_progress.submit(function(e){
            ...
            // bootbox.confirm({
            //     message: "Continue to submit this case?",
            //     buttons: {
            //         confirm: {
            //             label: 'Continue',
...
//tabel pending action form input
        // var forml3       = $("#form_add3");
        // forml3.submit(function(e){
        //     e.preventDefault();
        //     var idw       = $("#idw").val();
        //     alert(idw);
        //     Swal.fire({
        ...
        var forml11       = $("#form_add11");
        forml11.submit(function(e){
            e.preventDefault();
            var idw       = $("#idw").val();
            var ckt       = $("#ckt").val();
            var ckt_d       = $("#ckt_d").val();
