    ...
    <div id="modal_add3" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-full modal-dialog-form">
            <div class="modal-content">
                ...
                <div class="modal-body" style="height: 52px;">
                    <a type="button" class="close btnX" id="btnX" name="btnX">×</a>
                    <h5 class=" text-center text-form-judul">Action Form(2)</h5>
                    <p class="text-center lead text-form-sub-judul">Complete Form to Update this case
                    </p>
                </div>
                                ...
                                <div class="card-kanan-satu">
                                    <div class="row">
                                        <div class="col-lg-6 card-kanan-dua">
                                            <div class="">
                                                <div class="card-body">
                                                    <input type="hidden" class="" id="idpending" name="" value="" />
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-12">
                                                            <div class="form-group">
                                                                <label class="t-action">Problem Detail<span class="text-danger"> *</span></label>
                                                                <textarea class="form-control" rows="3" id="detpro2" name="detpro2" placeholder="add description      "></textarea>
                                                        ...
                                                        <div class="col-xl-12">
                                                            <div class="form-group">
                                                                <label class="t-action">Required Action<span class="text-danger"> *</span></label>
                                                                <textarea class="form-control" rows="3" id="maint2" name="maint2" placeholder="add description"></textarea>
                                                        ...
                                                        <div class="col-xl-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Select Date" data-provide="datepicker" id="pa_inp_sd" name="pa_inp_sd" readonly=''>
                                                                    <input type="text" class="form-control" id="pa_sd_time" name="pa_sd_time" readonly=''>
                                                                    <div class="input-group-append">
                                                                        <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                                    </div>
                                                                </div>
    ...
    <div id="modal_add4" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-full modal-dialog-form">
            <div class="modal-content">
                ...
                <div class="modal-body" style="height: 52px;">
                    <a type="button" class="close btnX" id="btnX" name="btnX">×</a>
                    <h5 class=" text-center text-form-judul">Action Form(4)</h5>
                    <p class="text-center lead text-form-sub-judul">Complete Form to Update this case
                    </p>
                </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-12">
                                                            <div class="form-group">
                                                                <label class="t-action">Problem Detail<span class="text-danger"> *</span></label>
                                                                <textarea class="form-control" rows="3" id="detpro3" name="detpro3" placeholder="add description      "></textarea>
                                                        ...
                                                        <div class="col-xl-12">
                                                            <div class="form-group">
                                                                <label class="t-action">Required Action<span class="text-danger"> *</span></label>
                                                                <textarea class="form-control" rows="3" id="maint3" name="maint3" placeholder="add description"></textarea>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-12 part_detail3">
                                                            <div class="form-group">
                                                                <label class="t-action">Spare Part Detail <span class="text-danger"> </span></label>
                                                                <textarea class="form-control" rows="3" id="pa_spd3" name="apa_spd3" placeholder="add description"></textarea>
                                                        ...
                                                        <div class="col-xl-12 date_arrived3">
                                                            <div class="form-group">
                                                                <label class="t-action" id="Date_sparepart">Spare Part Arrived (ETA)<span class="text-danger"> </span></label>
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" placeholder="Select Date" id="pa_spa" name="pa_spa" data-provide="datepicker" readonly=''>
                                                                    <!-- <input type="text" class="form-control" id="spa" name="spa" readonly=''> -->
                                                                    <div class="input-group-append">
                                                                        <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                                    </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="card-header card-kiri-satu" style="margin-top: 15px;">
                                    <div class="col-sm-6 col-lg-4 col-xl-12 tulisan-g" style="  height: 17px;color: #535687;">
                                        <i class="ion ion-md-alert"></i> General Information
                                    </div>
                                    </br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 card-kanan-dua">
                                            <div class="">
                                                ...
                                                <div class="card-body">
                                                    <input type="hidden" class="idw" id="idw" name="idw" value="" />
                                                    <input type="hidden" class="ckt" id="ckt" name="ckt" value="" />
                                                    <input type="hidden" class="" id="ckt_d" name="ckt_d" value="" />
                                                    <input type="hidden" class="" id="plant" name="plant" value="" />
                                                    <input type="hidden" class="" id="plant_d" name="plant_d" value="" />
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input_fields_wrap">
                                                                    <div class="input_fields_wrap1" style="height: 42px;">
                                                                        ...
                                                                        <input type="email" id="mytext[]" name="mytext[]" autocomplete=" current-password" required="" placeholder="Enter your email" class="int-pass int-text ">
                                                                        <!-- <i class=" ion ion-md-close  pUlang" style="margin-left: -30px; cursor: pointer;"></i> -->
                                                                        </Br>
                                                                    </div>
                                                                </div>
